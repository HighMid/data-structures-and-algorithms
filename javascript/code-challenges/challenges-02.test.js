...
const raisedToTheThird = (arr) => {
  ...
  arr.forEach(thing =>{
    toTheThird.push(Math.pow(thing, 3));
  });
...
const addOne = (arr) => arr.map(AddedOne => AddedOne + 1);

// const addOne = (arr) => {
//   return arr.map(AddedOne => AddedOne + 1);
// };
...
const addQuestion = (arr) => arr.map(AddedQuestion => AddedQuestion + '?');

// const addQuestion = (arr) =>{
//   return arr.map(AddedQuestion => AddedQuestion + '?');
// };
...
//     PowerOfValue.push(Math.pow(2, arr[i]));
//     console.log(PowerOfValue);
//   }

//   // arr.forEach(thing =>{
//   //   PowerOfValue.push(Math.pow(2, thing));
//   // });

//   return PowerOfValue;
// };

const forLoopTwoToThe = (arr) => arr.map(PowerOfValue => Math.pow(2, PowerOfValue));
...
//   let LoopPowerOfValue = [];

//   arr.forEach(thing =>{
//     LoopPowerOfValue.push(Math.pow(2 ,thing));
//   });

//   return LoopPowerOfValue;
// };

const forEachTwoToThe = (arr) => arr.map(LoopPowerOfValue => Math.pow(2, LoopPowerOfValue));
...
// const mapTwoToThe = (arr) => arr.map(MapPowerOfValue => Math.pow(2, MapPowerOfValue));

const mapTwoToThe = (arr) => {
  let MapPowerOfValue = [];

  for (let i = 0; i < arr.length; i++){
    MapPowerOfValue.push(Math.pow(2, arr[i]));
  }
  return MapPowerOfValue;

  // arr.forEach(thing =>{
  //   MapPowerOfValue.push(2 , thing);
  // })
}
